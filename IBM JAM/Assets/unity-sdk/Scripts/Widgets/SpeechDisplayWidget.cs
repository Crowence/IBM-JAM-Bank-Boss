...
namespace IBM.Watson.DeveloperCloud.Widgets
{
  ...
  public class SpeechDisplayWidget : Widget
  {
    ...
    private float m_ThresholdTimeFromLastInput = 0.0f; //3 secs as threshold time. After 3 secs from last OnSpeechInput, we are considering input as new input
